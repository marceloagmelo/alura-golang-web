...
import (
	...
	"github.com/marceloagmelo/alura-golang-web/models"
)
...
func Insert(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		precoConvertidoPraFloat, err := strconv.ParseFloat(preco, 64)
		if err != nil {
		...
		models.CriaNovoProduto(nome, descricao, precoConvertidoPraFloat, quantidadeConvertidaParaInt)
	}
